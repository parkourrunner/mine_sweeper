...
function Tile({
  state: { tileId, status, approximity = 0, hasMine, handleTileClick },
}: TileProps) {
  switch (status) {
    ...
    case TILE_STATUSES.OPEN: {
      ...
      let colorclass = "";
      switch (approximity) {
        case 1: {colorclass = "blue"; break;}
        case 2: {colorclass = "green"; break;}
        case 3: {colorclass = "red"; break;}
        case 4: {colorclass = "orange"; break;}
        case 5: {colorclass = "purple"; break;}
        case 6: {colorclass = "aqua"; break;}
        case 7: {colorclass = "brown"; break;}
        case 8: {colorclass = "cadetblue"; break;}
        default: break;
      }
      return (
        <div className="tile">
          <span className={colorclass}>{approximity > 0 ? approximity : null}</span>
        </div>
      );
    }
